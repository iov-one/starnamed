...
func NewWasmApp(logger log.Logger, db dbm.DB, traceStore io.Writer, loadLatest bool,
	...
	// NOTE: starname module should be before distribution module, in order for the yield computation to be correct
	app.mm.SetOrderBeginBlockers(
		upgradetypes.ModuleName, minttypes.ModuleName, starname.ModuleName, distrtypes.ModuleName, slashingtypes.ModuleName,
