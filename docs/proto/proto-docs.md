...
| `object_key` | [string](#string) |  | All the escrows has a unique key, in the starname objects the domain_name will be the key, and the domain_name*account_name will be the key. |
