...
type Fees struct {
	...
	// create_account_escrow is the fee to be paid to create an escrow for an account
	CreateAccountEscrow github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,22,opt,name=create_account_escrow,json=createAccountEscrow,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"create_account_escrow" yaml:"create_account_escrow"`
	// create_domain_escrow is the fee to be paid to create an escrow for a domain
	CreateDomainEscrow github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,23,opt,name=create_domain_escrow,json=createDomainEscrow,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"create_domain_escrow" yaml:"create_domain_escrow"`
	// update_escrow is the fee to be paid to update an escrow
	UpdateEscrow github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,24,opt,name=update_escrow,json=updateEscrow,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"update_escrow" yaml:"update_escrow"`
	// transfer_to_escrow is the fee to be paid to transfer coins to an escrow
	TransferToEscrow github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,25,opt,name=transfer_to_escrow,json=transferToEscrow,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"transfer_to_escrow" yaml:"transfer_to_escrow"`
	// refund_escrow is the fee to be paid to refund the account or domain placed in an escrow
	RefundEscrow github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,26,opt,name=refund_escrow,json=refundEscrow,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"refund_escrow" yaml:"refund_escrow"`
}
...
var fileDescriptor_67b15c914656dc9a = []byte{
	...
	,
}
...
func (this *Fees) Equal(that interface{}) bool {
	...
	if !this.CreateAccountEscrow.Equal(that1.CreateAccountEscrow) {
		return false
	}
	if !this.CreateDomainEscrow.Equal(that1.CreateDomainEscrow) {
		return false
	}
...
func (m *Fees) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0xc2
	{
		size := m.CreateDomainEscrow.Size()
		i -= size
		if _, err := m.CreateDomainEscrow.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintTypes(dAtA, i, uint64(size))
	}
	...
	dAtA[i] = 0xba
	{
		size := m.CreateAccountEscrow.Size()
		i -= size
		if _, err := m.CreateAccountEscrow.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintTypes(dAtA, i, uint64(size))
	}
...
func (m *Fees) Size() (n int) {
	...
	n += 2 + l + sovTypes(uint64(l))
	l = m.CreateAccountEscrow.Size()
	n += 2 + l + sovTypes(uint64(l))
	l = m.CreateDomainEscrow.Size()
	n += 2 + l + sovTypes(uint64(l))
...
func (m *Fees) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 22:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CreateAccountEscrow", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.CreateAccountEscrow.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 23:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CreateDomainEscrow", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.CreateDomainEscrow.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 24:
