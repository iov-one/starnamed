...
var (
	pattern_Query_Config_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"wasm", "v1beta1", "configuration", "config"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Fees_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"wasm", "v1beta1", "configuration", "fees"}, "", runtime.AssumeColonVerbOpt(true)))
)
